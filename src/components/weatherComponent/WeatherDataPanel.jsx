        ...
        <div>
            <div style={styles.div4}>
                <div style={styles.div5}>
                    <input type="text" style={styles.div6} placeholder="input a lat(1.13-1.47)" value={latitude} onChange={(e) => setLatitude(e.target.value)}></input>
                    <div style={styles.div7}>
                        <input type="text" style={styles.div8} placeholder="input a lng(103.60-104.05)" value={longitude} onChange={(e) => setLongitude(e.target.value)}></input>
